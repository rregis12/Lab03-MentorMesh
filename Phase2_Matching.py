        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for character in data:
                    if 'occupation' in character and character['occupation']:
                        occupations.append(character['occupation'])
                ...
                return common_majors + unique_occupations[:15]  
            else:
                
                return ["Computer Science", "Biology", "Psychology", "Business", "Engineering"]
